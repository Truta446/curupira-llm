...
def load_checkpoint(path: Path, device: str = "cpu") -> tuple[GPT, CharTokenizer, dict[str, Any]]:
    """Rebuild the model from a checkpoint file. Returns (model, tokenizer, info)."""
    ...
    info = {"step": blob["step"], "val_loss": blob["val_loss"], "config": config}
